...
el('hit-hijab').addEventListener('click', () => {
  if (state.talking) return;
  collectItem('hijab', 'الحجاب', 'assets/img/room2/hijab-item.png?v=1', 'hijab-img', 'hit-hijab');
});
el('hit-dress').addEventListener('click', () => {
  if (state.talking) return;
  collectItem('dress', 'الفستان', 'assets/img/room2/dress-item.png?v=1', 'dress-img', 'hit-dress');
});
el('hit-socks').addEventListener('click', () => {
  if (state.talking) return;
  collectItem('socks', 'الجوارب', 'assets/img/room2/socks-item.png?v=1', 'socks-img', 'hit-socks');
});
el('hit-bag').addEventListener('click', () => {
  if (state.talking) return;
  collectItem('bag', 'الحقيبة', 'assets/img/room2/bag-item.png?v=2', 'bag-img', 'hit-bag');
});
el('hit-boots').addEventListener('click', () => {
  if (state.talking) return;
  collectItem('boots', 'الحذاء', 'assets/img/room2/boots-item.png?v=1', 'boots-img', 'hit-boots');
});
...
if (location.search.includes('debug')) {
  ...
  btn('Переодевание', () => {
    ...
    nasheed.volume = dbToVol(-16);
    nasheed.play();
    collectItem('dress', 'الفستان', 'assets/img/room2/dress-item.png?v=2', null, null, false);
    collectItem('socks', 'الجوارب', 'assets/img/room2/socks-item.png?v=1', null, null, false);
    collectItem('hijab', 'الحجاب', 'assets/img/room2/hijab-item.png?v=1', null, null, false);
    collectItem('boots', 'الحذاء', 'assets/img/room2/boots-item.png?v=1', null, null, false);
    collectItem('bag', 'الحقيبة', 'assets/img/room2/bag-item.png?v=2', null, null, false);
    showScreen('room2');
  });
